        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex">
                        <a href="/driver/tambah" class="no-decoration">
                        ...
                        <a href="/driver" class="text-4xl font-bold text-gray-900 dark:text-white m-auto text-center">
                            <h2>Driver</h2>
                        </a>
                    </div>
                    <hr class="h-1 bg-gray-100 rounded md:my-3 dark:bg-gray-700">
                    @if ($driver['status'] == 404)
                        <p class="text-lg">Tidak ada driver yang tersimpan di database.</p>
                    @else
                    {{-- Tabel --}}
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b hover:bg-blue-600 hover:text-white transition duration-500 ease-in-out">
                                    <th scope="row" class="px-6 py-4 border rounded p-1 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">
                                        ...
                                        <br>
                                        <form action="/driver/hapus={{ $d['id'] }}" method="POST">
                                            @csrf
                                            @method('delete')
                                                ...
                                                <div class="relative p-4 w-full max-w-md max-h-full">
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        ...
                                                        <div class="p-4 md:p-5 text-center">
                                                            ...
                                                            <h3 class="text-lg font-normal text-gray-500 dark:text-gray-400">Driver</h3>
                                                            <p>Nama: {{ $d['driver_name'] }}</p>
