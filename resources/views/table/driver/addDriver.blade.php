        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    {{-- Form --}}
                    <form action="/driver/store" method="POST" enctype="multipart/form-data" id="myForm">
                        @csrf
                        <div class="mb-6">
                            <label for="driver_name" class="block mb-2 text-sm font-medium text-gray-900">Driver Name <i class="fa-solid fa-asterisk fa-sm" style="color: #e02424;"></i></label>
                            <input autocomplete="off" type="text" id="driver_name" name="driver_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block sm:w-1/2 w-full p-2.5" >
                            @error('driver_name')
                        ...
                        <div id="popup-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow">
                                    <button type="button" class="absolute active:scale-95 top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="popup-modal">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <h3 class="text-lg font-normal text-gray-500">Driver ini?</h3>
