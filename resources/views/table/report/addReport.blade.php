                ...
                <div class="p-6 text-gray-900">
                    <div class="flex">
                        <p class="text-3xl font-bold text-gray-900 m-auto">
                            Tambah Laporan Jalan
                        </p>
                    </div>
                    <hr class="h-1 bg-gray-100 rounded md:my-3 mb-5">
                    {{-- Form --}}
                    <form action="/laporan/store" method="POST" enctype="multipart/form-data" id="myForm">
                        @csrf
                        <div class="mb-6">
                        ...
                        <div class="grid md:grid-cols-4 md:gap-6">
                            <div class="mb-6">
                                ...
                                <input autocomplete="off" value="{{$yesterdayDate}}" type="date" id="departure_date" name="departure_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" >
                            ...
                            <div class="mb-6">
                                ...
                                <input autocomplete="off" type="time" id="departure_time" name="departure_time" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" >
                            ...
                            <div class="mb-6">
                                ...
                                <input autocomplete="off" type="time" id="arrival_time" name="arrival_time" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                                @error('arrival_time')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-small">{{ $message }}</span></p>
                                @enderror
                            </div>
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <h3 class="text-lg font-normal text-gray-500 dark:text-gray-400">Laporan Jalanan ini?</h3>
