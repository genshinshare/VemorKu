        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    {{-- Form --}}
                    <form action="/laporanKlaim/{{ $report_finance['report_finance']['report_finance_id'] }}" method="POST" enctype="multipart/form-data" id="myForm">
                        @csrf
                        @method('put')
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="mb-6">
                                ...
                                <select id="vehicle_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="vehicle_id">
                                    @foreach ($vehicle['vehicle'] as $v)
                                        @if ($v['vehicle_id'] == $report_finance['report_finance']['vehicle_id'])
                                            <option value="{{$v['vehicle_id']}}" selected>{{$report_finance['report_finance']['vehicle_id']}}</option>
                                        @else
                            ...
                            <div class="mb-6">
                                <label for="report_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Report ID <small>(Isi jika klaim BBM)</small></label>
                                <input autocomplete="off" value="{{ $report_finance['report_finance']['report_id'] }}" type="number" min="1" id="report_id" name="report_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                                @error('report_id')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-small">{{ $message }}</span></p>
                                @enderror
                            </div>
                        ...
                        <div class="grid md:grid-cols-4 md:gap-6">
                            ...
                            <div class="mb-6">
                                ...
                                <input autocomplete="off" value="{{$report_finance['report_finance']['fuel']}}" type="number" step="0.01" min="0.00" id="fuel" name="fuel" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                                @error('fuel')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-small">{{ $message }}</span></p>
                                @enderror
                            </div>
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        <h3 class="text-lg font-normal text-gray-500 dark:text-gray-400">Apa anda yakin</h3>
