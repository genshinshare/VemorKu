                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="/import/store" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto">
                        ...
                        <div class="mb-6">
                            ...
                            <input class="cursor-pointer bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 
                            focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                            dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder:text-body" id="file_input" type="file" 
                            accept=".xlsx,.xls,.csv" name="file_input">
                            @error('file-input')
