                ...
                <div class="p-6 text-gray-900">
                    <div class="flex">
                        <p class="text-3xl font-bold text-gray-900 dark:text-white m-auto">
                            Car Condition Data Utilitas Report
                        </p>
                    </div>
                    ...
                    @php
                        $yearNow = date("Y");
                    @endphp
                    <form action="/carcondition/pdf" method="GET" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-6">
                        ...
                        <button type="submit" id="btn-loader" class="text-white duration-300 bg-blue-600 hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Export PDF Car Condition</button>
                    </form>
                </div>
            </div>
        </div>
