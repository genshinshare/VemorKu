            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @php
                        $yearNow = date("Y");
                    @endphp
                    <form action="/vemor/pdf" method="GET" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-6">
                            ...
                            <select id="vehicle_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="vehicle_id">
                                <option>Pilih Vehicle ID</option>
                        ...
                        <button type="submit" id="btn-loader" class="text-white duration-300 bg-blue-600 hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Export PDF Vemor</button>
                    </form>
                </div>
            </div>
        </div>
